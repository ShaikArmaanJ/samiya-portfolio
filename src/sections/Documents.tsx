...
import { FileDown, FileText, Image as ImageIcon, Lock } from 'lucide-react';

const Documents = () => {
  const certificates = [
    { title: "Internship Completion Certificate", status: "Coming Soon" },
    { title: "Hackathon Participation Certificate", status: "Coming Soon" }
  ];
